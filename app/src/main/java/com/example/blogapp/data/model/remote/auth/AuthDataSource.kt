package com.example.blogapp.data.model.remote.auth
...
class AuthDataSource {
    ...
    suspend fun signUp(email: String, password: String, username: String): FirebaseUser? {
        ...
        authResult.user?.uid?.let { uid ->
            FirebaseFirestore.getInstance().collection("users").document(uid).set(User(username,email,"FOTO_URL.PNG")).await()
        }
